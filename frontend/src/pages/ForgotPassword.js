...
const ForgotPassword = () => {
    ...
    const submitHandler = async (e) => {
        ...
        try {
            setLoading(true);
            await axios.post('/api/v1/users/forgot-password', { email: email }, {
                headers: {
                    "Content-Type": "application/json"
                }
            })
            setLoading(false);
            message.success("Password reset link sent successfully to your mail");
            navigate("/login");
        } catch (error) {
            setLoading(false);
                                ...
                                <div className="card-body px-lg-5 py-lg-5">
                                    ...
                                    <form onSubmit={submitHandler}>
                                        ...
                                        <div className="text-center">
                                            <button type="submit" className="btn btn-primary my-4">Send password reset mail</button>
                                        </div>
                                    </form>
                                </div>
                            </div>
